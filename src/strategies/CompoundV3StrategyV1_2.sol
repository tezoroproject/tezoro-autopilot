...
contract CompoundV3StrategyV1_2 is IStrategy, ReentrancyGuard {
    ...
    function harvest(address rewardsModule) external override onlyVault nonReentrant returns (uint256) {
