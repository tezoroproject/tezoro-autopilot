...
contract CompoundV3StrategyV1_2Test is Test {
    ...
    // =========================================================================
    // Audit fix #7 (Oak 2026-04-24): availableLiquidity respects withdraw pause
    // =========================================================================
    ...
    function test_auditFix7_availableLiquidityIsZeroWhenWithdrawPaused() public {
    ...
    function test_auditFix7_isHealthyFalseWhenSupplyPaused() public {
    ...
    function test_auditFix7_isHealthyFalseWhenWithdrawPaused() public {
        comet.setWithdrawPaused(true);
    ...
    function test_auditFix16_constructorRevertsOnBaseTokenMismatch() public {
    ...
    function test_auditFix16_constructorAcceptsMatchingBaseToken() public {
