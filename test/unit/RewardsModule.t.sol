...
contract RewardsModuleTest is Test {
    ...
    function test_sweepToVault_increasesVaultTotalAssets() public {
        ...
        // Parked rewards are already in totalAssets, so the
    ...
    function test_fullRewardsCycle() public {
        ...
        // Baseline fee shares: captured before any reward activity. Post audit-this fix
        ...
        // The share-price increase is realised at swap time
        ...
        // --- Step 5: Fee already accrued during sweep (post audit-this fix) ---
        vm.prank(alice);
