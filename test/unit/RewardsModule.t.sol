...
contract RewardsModuleTest is Test {
    ...
    // =========================================================================
    // Audit fix #10 (Oak 2026-04-24): typed wrappers pin recipient on-chain
    // =========================================================================
    ...
    function test_auditFix10_claimMorphoUrdPinsRecipientToModule() public {
    ...
    function test_auditFix10_claimMerklPinsRecipientForEveryEntry() public {
    ...
    function test_auditFix10_claimMorphoUrdRequiresWhitelist() public {
        MockMorphoUrd urd = new MockMorphoUrd();
        bytes32[] memory proof = new bytes32[](0);
    ...
    function test_auditFix10_claimMerklRequiresWhitelist() public {
        MockMerklDistributor distributor = new MockMerklDistributor();
    ...
    /// @notice Audit fix #28 (Oak 2026-04-24): swap must reject
    ...
    function test_auditFix28_swapRejectsZeroMinAmountOut() public {
        vm.prank(admin);
        module.setRouterWhitelist(address(router), true);
