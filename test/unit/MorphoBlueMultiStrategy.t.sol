...
contract MorphoBlueMultiStrategyTest is Test {
    ...
    // =========================================================================
    // Audit fix #30 (Oak 2026-04-24): isHealthy is strategy-level, not
    ...
    function test_auditFix30_isHealthyFalseOnFullyUtilisedMarket() public {
        _fundVaultAndApprove(100e6);
        vm.prank(vaultAddr);
        strategy.deposit(100e6);
        vm.prank(keeperAddr);
    ...
    function test_auditFix30_isHealthyFalseWhenAllMarketsFrozen() public {
        _fundVaultAndApprove(100e6);
        vm.prank(vaultAddr);
        strategy.deposit(100e6);
        vm.prank(keeperAddr);
    ...
    function test_auditFix30_isHealthyTrueWhenAtLeastOneMarketHealthy() public {
