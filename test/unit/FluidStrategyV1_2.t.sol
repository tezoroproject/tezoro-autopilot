...
contract FluidStrategyV1_2Test is Test {
    ...
    // =========================================================================
    // EmergencyWithdraw caps to maxRedeem
    // =========================================================================
    ...
    function test_emergencyWithdrawCapsToMaxRedeem() public {
    ...
    ///         AaveV3StrategyV1_2.emergencyWithdraw.
    function test_emergencyWithdrawReturnsZeroWhenFullyCapped() public {
    ...
    function test_emergencyWithdrawDrainsWhenUncapped() public {
        vm.prank(vaultAddr);
        uint256 withdrawn = strategy.emergencyWithdraw();
    ...
    // =========================================================================
    // Constructor validates fToken asset
    // =========================================================================
    ...
    function test_constructorRevertsOnFTokenAssetMismatch() public {
    ...
    function test_constructorAcceptsMatchingFToken() public {
