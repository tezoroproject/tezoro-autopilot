...
contract FluidStrategyV1_2Test is Test {
    ...
    // =========================================================================
    // Audit fix #27 (Oak 2026-04-24): isHealthy uses depositability quote
    // =========================================================================
    ...
    function test_auditFix27_isHealthyFalseWhenDepositsPaused() public {
    ...
    ///         initial allocation.
    function test_auditFix27_isHealthyTrueOnEmptyButDepositableMarket() public {
