...
contract TezoroV1_2Test is Test {
    ...
    /// @notice Audit fix #24 (Oak 2026-04-24): zero idle buffer is an
    ...
    function test_auditFix24_zeroIdleBufferIsAccepted() public {
    ...
    // =========================================================================
    // Audit fix #5: removeStrategy reverts on incomplete emergency exit
    // =========================================================================
    ...
    // =========================================================================
    // Audit fix #6 (Oak 2026-04-24): tiny interactions cannot raise HWM
    // =========================================================================
    ...
    function test_auditFix6_dustDonationDoesNotMoveHwm() public {
        vm.prank(alice);
        vault.deposit(DEPOSIT, alice);
    ...
    function test_auditFix6_zeroShareDepositReverts() public {
    ...
    function test_auditFix6_zeroMintReverts() public {
        vm.prank(alice);
        vm.expectRevert(TezoroV1_2.ZeroSharesMinted.selector);
        vault.mint(0, alice);
    }
    ...
    // =========================================================================
    // Audit fix #11 (Oak 2026-04-24): cap enforcement uses live total assets
    // =========================================================================
    ...
    function test_auditFix11_maxDepositReflectsLiveStrategyBalance() public {
        // Cap = 100k.
    ...
    function test_auditFix11_liveTotalAssetsFallsBackOnBrokenStrategy() public {
        uint256 cap = 100_000e6;
        vm.prank(admin);
        vault.setDepositCap(cap);
    ...
    // =========================================================================
    // Audit fix #13 (Oak 2026-04-24): setPerformanceFee refreshes tracked
    //                                 BEFORE accruing fee
    // =========================================================================
    ...
    function test_auditFix13_feeAccruesAtOldRateOnRaise() public {
        vm.prank(alice);
        vault.deposit(DEPOSIT, alice);
    ...
    // =========================================================================
    // Audit fix #33 (Oak 2026-04-24): forceRedeem is recovery, not migration
    // =========================================================================
    ...
    ///         forceRedeem NatSpec.
    function test_auditFix33_forceRedeemReturnsAssetsToShareHolder() public {
        vm.prank(alice);
        vault.deposit(DEPOSIT, alice);
    ...
    function test_auditFix33_batchForceRedeemSkipsTransferredHolder() public {
        vm.prank(alice);
        vault.deposit(DEPOSIT, alice);
