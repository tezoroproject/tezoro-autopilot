...
contract TezoroV1_2Test is Test {
    ...
    function test_rebalance_withdrawReturnsMoreThanTracked() public {
        ...
        // TrackedBalance is refreshed to the
    ...
    function test_withdraw_waterfall_strategyReturnsMoreThanTracked() public {
        ...
        // TrackedBalance is refreshed to the strategy's live
    ...
    // =========================================================================
    // Bounded dust tolerance in normal withdraw
    // =========================================================================
    ...
    function test_underdeliveryWithinToleranceSucceeds() public {
        vm.prank(alice);
        vault.deposit(DEPOSIT, alice);
        ...
        // and exercises the post-execution underdelivery path that this fix patches.
        uint256 maxW = vault.maxWithdraw(alice);
    ...
    function test_underdeliveryAboveToleranceReverts() public {
        vm.prank(alice);
        vault.deposit(DEPOSIT, alice);
    ...
    // =========================================================================
    // Refresh live trackedBalance on overdelivery
    // =========================================================================
    ...
    // =========================================================================
    // Waterfall haircut must not socialise
    ...
    function test_haircutDoesNotSocialiseAcrossStrategies() public {
        vm.prank(alice);
        vault.deposit(DEPOSIT, alice);
    ...
    // =========================================================================
    // IsHealthy gates only the deposit branch
    // =========================================================================
    ...
    function test_unhealthyStrategyStillWithdrawnByRebalance() public {
        vm.prank(alice);
        vault.deposit(DEPOSIT, alice);
    ...
    function test_unhealthyStrategyBlocksDeposit() public {
        vm.prank(alice);
        vault.deposit(DEPOSIT, alice);
    ...
    // =========================================================================
    // Refuse RewardsModule rotation while the outgoing module still holds base asset
    // =========================================================================
    ...
    function test_rotationBlockedWhileOldModuleHoldsAsset() public {
    ...
    ///         to strand).
    function test_initialSetNotBlockedWhenVaultIdleHasAsset() public {
    ...
    function test_rotationWorksAfterDrain() public {
        address rmOld = makeAddr("rmOld");
        vm.prank(admin);
        vault.setRewardsModule(rmOld);
    ...
    function test_pauseStrategyRevokesAllowance() public {
        ...
        assertEq(
            ...
            type(uint256).max,
            "precondition: strategy approved on add"
        );
    ...
    // =========================================================================
    // RecallToIdle revokes ERC20 approval
    // =========================================================================
    ...
    function test_recallToIdleRevokesAllowance() public {
        vm.prank(alice);
        vault.deposit(DEPOSIT, alice);
    ...
    // =========================================================================
    // RemoveStrategy/recallToIdle refresh
    ...
    function test_removeStrategyRefusesPartialRecoveryAfterRefresh() public {
        vm.prank(alice);
        vault.deposit(DEPOSIT, alice);
    ...
    function test_recallToIdleRefreshesTrackedBeforeWithdraw() public {
        vm.prank(alice);
        vault.deposit(DEPOSIT, alice);
    ...
    // =========================================================================
    // Timelock has a bounded execution window
    // =========================================================================

    /// @notice A proposal still inside the GRACE_PERIOD executes normally.
    function test_timelockExecutesInsideGracePeriod() public {
        vm.prank(admin);
        vault.setTimelockDelay(1 days);
        ...
        // Reconcile to clear the staleness gate.
        vault.reconcile();
    ...
    function test_timelockRevertsAfterGracePeriodExpires() public {
        vm.prank(admin);
        vault.setTimelockDelay(1 days);
    ...
    function test_isTimelockReadyFalseAfterExpiry() public {
        vm.prank(admin);
        vault.setTimelockDelay(1 days);
    ...
    function test_expiredProposalCanBeReproposed() public {
        vm.prank(admin);
        vault.setTimelockDelay(1 days);
