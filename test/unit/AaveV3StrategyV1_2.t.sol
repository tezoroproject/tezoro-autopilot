...
// sufficient — the strategy reads only the configuration bitmap, never the
// full getReserveData tuple.
contract MockAavePool {
    ...
    function withdraw(address asset_, uint256 amount, address to) external returns (uint256) {
        ...
        // when reserves are illiquid. The strategy guards against this by
        // capping the requested amount to availableLiquidity() upstream.
    ...
    ///         a manual-offset staticcall in its constructor). Inline assembly
    ///         avoids Solidity's stack-too-deep limit on the 15 named-return
    ///         tuple.
...
contract AaveV3StrategyV1_2Test is Test {
    ...
    // =========================================================================
    // AvailableLiquidity respects PAUSED/inactive
    // =========================================================================

    function test_availableLiquidityIsZeroWhenPaused() public {
    ...
    function test_availableLiquidityIsZeroWhenInactive() public {
    ...
    function test_availableLiquidityIgnoresFrozenForWithdrawals() public {
    ...
    // =========================================================================
    // IsHealthy false on inactive/frozen/paused
    // =========================================================================

    function test_isHealthyFalseWhenFrozen() public {
    ...
    function test_isHealthyFalseWhenPaused() public {
        pool.setConfig(ACTIVE_BIT | PAUSED_BIT);
        assertFalse(strategy.isHealthy(), "paused reserve must not be healthy");
    }

    function test_isHealthyFalseWhenInactive() public {
        pool.setConfig(0);
        assertFalse(strategy.isHealthy(), "inactive reserve must not be healthy");
    }

    // =========================================================================
    // EmergencyWithdraw capped to liquid reserves
    // =========================================================================
    ...
    function test_emergencyWithdrawReturnsZeroOnPausedReserve() public {
        pool.setConfig(ACTIVE_BIT | PAUSED_BIT);
    ...
    function test_constructorRevertsOnATokenMismatch() public {
    ...
    function test_constructorAcceptsMatchingAToken() public {
    ...
    function test_emergencyWithdrawCapsToAvailableLiquidity() public {
